...
export default {
  ...
  methods: {
    ...
    handleRowResizeLineMousedown ($event) {
      ...
      // 获取cell位置
      let cell = this.$refs.table.querySelector(`.cell-${rowIndex}-1`)
    ...
    handleColResizeLineMousedown ($event) {
      ...
      // 获取cell位置
      let cell = this.$refs.table.querySelector(`.cell-1-${colIndex}`)
      let cellX = cell.offsetLeft
      let cellY = cell.offsetTop
      this.resizeModel.cellX = cellX
      this.resizeModel.cellY = cellY
    ...
    showSelectBox () {
      ...
      // let tableTop = tableEl.offsetTop - scrollTop
      // let tableLeft = tableEl.offsetLeft - scrollLeft
