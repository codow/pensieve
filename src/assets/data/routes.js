        ...
        children: [
          {
            ...
            children: [
              ...
              },
              {
                ...
                path: "porsche-911",
                component: () =>
                  import("@/views/demo/animations/3d/porsche_911"),
                meta: {
                  title: "3D动画--保时捷911",
                  keepAlive: true,
                },
            ...
            children: [
              {
                ...
                children: [
                  ...
                  },
                  {
                    ...
                    path: "object",
                    component: () =>
                      import("@/views/demo/animations/svg/encapsulation/index"),
                    meta: {
                      title: "图形对象封装",
                    },
                  },
                  {
                    ...
                    component: () =>
                      import(
                        "@/views/demo/animations/svg/encapsulation/svgIconDraw"
                      ),
                    meta: {
                      title: "Svg图标绘制",
                    },
                  },
                  {
                    ...
                    component: () =>
                      import(
                        "@/views/demo/animations/svg/encapsulation/virtualScroll.vue"
                      ),
                    meta: {
                      title: "Svg虚拟滚动",
                    },
                ...
                children: [
                  {
                    ...
                    path: "path",
                    component: () =>
                      import("@/views/demo/animations/svg/demo/path"),
                    meta: {
                      title: "SVG-PATH示例",
                    },
                  },
